...
## Een bruikbare kennisstructuur

De startpagina geeft overzicht. Het Manifesto legt onderwerpen uit, Analyseproces maakt ze toepasbaar en Resources geeft het gereedschap. Een openbare analyse verwijst terug naar de gebruikte methode. De auteurspagina en redactionele werkwijze maken de herkomst duidelijk.

Ik kies beschrijvende titels en links die vertellen wat de lezer krijgt. Een pagina moet zelfstandig te begrijpen zijn, terwijl de links helpen om de samenhang te ontdekken. Ik voeg geen losse pagina toe alleen om een extra zoekterm te bezetten.
...
## Zorgvuldigheid bij financiële onderwerpen

Financiële informatie kan invloed hebben op belangrijke beslissingen. Daarom maak ik ervaring, bronnen, belangen, onzekerheden en correcties zichtbaar. Ik gebruik YMYL (Your Money or Your Life, de aanduiding van Google voor onderwerpen die iemands geld of gezondheid raken) en E-E-A-T (ervaring, deskundigheid, gezag en betrouwbaarheid, de kenmerken waarop Google de kwaliteit van zulke pagina's beoordeelt) als aandachtspunten voor vertrouwen en kwaliteit, niet als keurmerk dat de methode een bepaalde positie in zoekresultaten geeft.

## Openbaar betekent door mij nagelezen
