...
Een ontbrekende vraag in een call bewijst niet dat niemand dat onderwerp heeft onderzocht. Ik noteer wat in de beschikbare bronnen zichtbaar is. De open vragen voor verdere dataverzameling staan bij [analistenonderzoek](../05-Resources/Analistenonderzoek.md).
...
Mijn basisprognose loopt over jaren 1 tot en met 11. Jaar 0 bevat de huidige investering. Een eindwaarde op basis van een koers-winstverhouding hoort bij de aandelenwaarde; kasstroom naar alle financiers vraagt een andere verwerking. Die aansluiting staat uitgewerkt in [het DCF-model](06-DCF-Model.md).
...
De opbouw staat in [rapportage](09-Rapportage.md). Ik bepaal apart welke delen van een werkdossier geschikt zijn voor publicatie.
