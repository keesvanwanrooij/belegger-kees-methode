...
De [promptbibliotheek](../05-Resources/AI-Prompts/prompts-library.md) gebruikt dezelfde uitgangspunten:
...
Bij een [DCF](06-DCF-Model.md) controleer ik onder meer de kasstroomdefinitie, het aantal jaren, de plaats van de eindwaarde en de behandeling van schuld en aandelen. Ik test eenvoudige situaties waarvan ik de uitkomst zelf kan berekenen. Een model dat doorrekent is nog niet inhoudelijk juist.
...
Werk je als AI-agent aan deze repository, lees dan eerst [de agentstartpagina](../CLAUDE.md).
